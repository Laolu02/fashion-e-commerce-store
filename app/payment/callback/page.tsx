      ...
      <div className="min-h-screen bg-[#F5F5F5] py-12 px-4 flex flex-col items-center justify-center font-mono">
        <div className="w-full max-w-2xl bg-white p-8 lg:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.1)] relative border-t-8 border-green-600">
          ...
          <div className="flex gap-4">
            <Link 
              href="/" 
              className="flex-1 bg-primary text-white py-4 text-center text-xs font-black uppercase tracking-wider hover:bg-black transition-colors"
            >
              Continue Shopping
            </Link>
            <Link 
              href="/orders" 
              className="flex-1 border-2 border-primary text-primary py-4 text-center text-xs font-black uppercase tracking-wider hover:bg-primary hover:text-white transition-colors"
            >
              View Orders
            </Link>
          </div>
